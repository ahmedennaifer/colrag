...
class Query:
    def __init__(self, document_store):
        self.template = """
            You are a world class Wikipedia specialist. Your task is to read Wikipedia articles
            and synthesize a response to the query of the user. You need to be as thorough and detail oriented
            as possible. If you cannot accurately identify the requested info or related article content,
            say you don't have access to that specific information.
